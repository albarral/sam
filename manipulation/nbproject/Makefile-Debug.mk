...
LDLIBSOPTIONS=-Wl,-rpath,../network/dist/Debug/GNU-Linux-x86 -L../network/dist/Debug/GNU-Linux-x86 -lsam_network -Wl,-rpath,../backbone/dist/Debug/GNU-Linux-x86 -L../backbone/dist/Debug/GNU-Linux-x86 -lsam_backbone -Wl,-rpath,../utils/dist/Debug/GNU-Linux-x86 -L../utils/dist/Debug/GNU-Linux-x86 -lsam_utils -Wl,-rpath,../utils2/dist/Debug/GNU-Linux-x86 -L../utils2/dist/Debug/GNU-Linux-x86 -lsam_utils2 -llog4cxx

# Build Targets
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libsam_manip.${CND_DLIB_EXT}

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libsam_manip.${CND_DLIB_EXT}: ../network/dist/Debug/GNU-Linux-x86/libsam_network.so
