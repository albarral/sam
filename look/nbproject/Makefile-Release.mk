...
${OBJECTDIR}/src/sam/look/LookManager.o: src/sam/look/LookManager.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/sam/look/LookManager.o src/sam/look/LookManager.cpp

${OBJECTDIR}/src/sam/look/bus/Bus.o: src/sam/look/bus/Bus.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/sam/look/bus
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/sam/look/bus/Bus.o src/sam/look/bus/Bus.cpp

${OBJECTDIR}/src/sam/look/bus/COBus.o: src/sam/look/bus/COBus.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/sam/look/bus
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/sam/look/bus/COBus.o src/sam/look/bus/COBus.cpp

${OBJECTDIR}/src/sam/look/bus/SOBus.o: src/sam/look/bus/SOBus.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/sam/look/bus
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/sam/look/bus/SOBus.o src/sam/look/bus/SOBus.cpp
...
${OBJECTDIR}/src/sam/look/modules/tracker/Tracker.o: src/sam/look/modules/tracker/Tracker.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/sam/look/modules/tracker/Tracker.o src/sam/look/modules/tracker/Tracker.cpp
